      ...
      {open && (
        ...
        >
          <div className="relative" onClick={(e) => e.stopPropagation()}>
            ...
            />
            <div className="absolute -top-[3dvh] -right-[3dvh] cursor-pointer w-[8dvh] aspect-square p-[0.5dvh] rounded-full bg-secondary z-20">
            ...
            <div className="absolute inset-0 w-full z-10 top-0 px-[5dvh] ">
              ...
              <div className="flex flex-col gap-[1dvh] font-gilroy text-[1.5dvh] text-secondary text-start">
                <p>
                  Ở nhiều nhà tình thương, trại mồ côi và vùng sâu vùng xa, các
                  em nhỏ lớn lên mà chưa từng được ai nói cho nghe: "Cơ thể con
                  là của con. Con có quyền nói không." Có em chưa biết tên gọi
                  đúng của các bộ phận trên cơ thể mình. Có em không biết rằng
                  sự đụng chạm khiến mình khó chịu — là không bình thường, và em
                  hoàn toàn có quyền từ chối.
                </p>
                <p>
                  Tụi mình muốn thay đổi điều đó. Và tụi mình tin rằng kiến thức
                  về cơ thể, về sự đồng thuận, về quyền được an toàn — không
                  phải đặc quyền của riêng ai.
                </p>
                <p>
                ...
                <p>
                  ...
                  "giáo dục giới tính" vẫn là ba từ khiến người lớn đỏ mặt quay
                  đi.
                </p>
                <p>
                  Bạn không cần làm gì thêm. Chỉ cần bạn chọn học cùng SEBT, bạn
                  đã đồng hành cùng tụi mình rồi.
                </p>
