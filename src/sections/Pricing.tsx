const itemsDesktop = [
  { type: "image", img: "/images/avt-pricing/avt-1.png" },
  {
    type: "text",
    title: "VIDEO",
    desc: "Toàn bộ 7 phần học với video chia nhỏ, dễ theo dõi",
  },
  { type: "image", img: "/images/avt-pricing/avt-2.png" },
  { type: "text", title: "Tài liệu", desc: "Tài liệu bổ trợ (PDF, slide)" },
  { type: "text", title: "Bài tập", desc: "Bài tập thực hành áp dụng ngay" },
  { type: "image", img: "/images/avt-pricing/avt-3.png" },
  {
    type: "text",
    title: "Nhóm hỗ trợ",
    desc: "Nhóm hỗ trợ học tập riêng (có thể dùng nickname)",
  },
  { type: "image", img: "/images/avt-pricing/avt-4.png" },
  { type: "image", img: "/images/avt-pricing/avt-5.png" },
  {
    type: "text",
    title: "Workshop",
    desc: "Workshop Zoom hàng tháng với Trang",
  },
  { type: "image", img: "/images/avt-pricing/avt-6.png" },
  {
    type: "text",
    title: "Q&A",
    desc: "Hỏi đáp & phản hồi trong thời gian học",
  },
];
...
export default function Pricing() {
  ...
  const smallTicketsInView = useInView(smallTicketsRef, {
    once: true,
    amount: 0.8,
  });
  ...
  return (
    <section className="w-full bg-beige relative translate-y-[-1px]">
      <div className="absolute bottom-0 z-0 lg:block hidden">
        <img
          src="images/pricing/bg-pricing.png"
          alt="bg-pricing"
      ...
      <div className="flex flex-col items-center pb-[4vw]">
        ...
        <motion.div
          ...
          initial={{ opacity: 0, y: 72 }}
          animate={boardInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 72 }}
          transition={{ duration: 1.5, ease }}
        >
          {/* desktop */}
          <div className="lg:grid hidden grid-cols-4 relative z-10">
              ...
              <div key={i} className="border border-red-900 aspect-square">
                {item.type === "image" ? (
                  ...
                  <div className="flex h-full flex-col items-center justify-center p-[1.2dvw] text-center">
                    <h3 className="font-gilroy font-bold  text-[1.4dvw] text-secondary">
                      {item.title}
                    </h3>
                    <p className="font-gilroy font-normal text-[1.4dvw] text-secondary pt-[0.4dvw]">
                      {item.desc}
                    </p>
                  </div>
                )}
            ...
            {itemsMobile.map((item, i) => (
              <div key={i} className="border border-red-900 aspect-square">
                {item.type === "image" ? (
                  ...
                  <div className="flex h-full flex-col items-center justify-center p-[1.2dvw] text-center">
                    <h3 className="font-gilroy font-bold text-[16px] text-secondary">
                      {item.title}
                    </h3>
                    <p className="font-gilroy font-normal text-[14px] text-secondary pt-[8px]">
                      {item.desc}
                    </p>
                  </div>
                )}
        ...
        <div className="lg:block hidden w-[76.5dvw] translate-x-[2.5%] mt-[5.2dvw]">
          <motion.div
            ...
            initial={{ opacity: 0, y: 72 }}
            animate={
              ticketInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 72 }
            }
            transition={{ duration: 1.5, ease }}
          >
            <img
              src="images/pricing/ticket.png"
            ...
            <div className="absolute inset-0 font-gilroy text-secondary flex flex-col items-center pt-[2.3%] pl-[2.2%] pr-[16.5%] gap-[1dvw]">
              ...
              <p className="font-gilroy font-medium text-[2dvw] text-secondary leading-none ">
                Only for you
              </p>
              <p className="font-gilroy font-normal text-[2dvw] text-[#C18989] leading-none ">
                +Tặng 1 Love Box tri ân (chỉ dành cho founding members)
              </p>
              ...
              <h1 className=" font-lamoric text-[6.67dvw] text-secondary font-normal leading-none ">
                1.299.000đ
              </h1>
            </div>
          </motion.div>
        ...
        >
          ...
          >
            <img
              src="/images/pricing/ticket-small.png"
              className="w-full h-auto object-contain"
            />
            <div className="absolute inset-0 font-gilroy text-secondary flex flex-col items-center pt-[5.5%] pl-[4.4%] pr-[21.5%] gap-[1.6dvw]">
              <h3 className="font-morgan font-normal text-[2.3dvw] text-primaryText leading-none">
                CORE VERSION
              </h3>
              <p className="font-gilroy font-normal text-[1.15dvw] text-secondary leading-none">
                HỌC ĐỦ, DÙNG NGAY
              </p>
          ...
          >
            ...
            <div className="absolute inset-0 font-gilroy text-secondary flex flex-col items-center pt-[8%] pl-[5%] pr-[25%] gap-[1dvw]">
              <h3 className="font-morgan font-normal text-[1.8dvw] text-primaryText leading-none ">
                LIFETIME PEACE-OF-MIND
              </h3>
              <p className="font-gilroy font-normal text-[1.15dvw] text-secondary leading-none ">
                ĐƯỢC CHỌN NHIỀU NHẤT
              </p>
              <p className="font-gilroy font-normal text-[1.15dvw] text-[#C18989] leading-none ">
                Cập nhật trọn đời
              </p>
        ...
        <MobileVoucherInView>
          <div className="relative w-[101%] translate-x-[2.5%]">
            ...
            <div className="absolute inset-0 font-gilroy text-secondary flex flex-col items-center pt-[2.3%] pl-[2.2%] pr-[16.5%] gap-[1dvw]">
              ...
              <p className="font-gilroy font-medium text-[2.6dvw] text-secondary leading-none mt-[.5dvw]">
                Only for you
              </p>
              <p className="font-gilroy font-normal text-[2.6dvw] text-[#C18989] leading-none mt-[.5dvw]">
                +Tặng 1 Love Box tri ân (chỉ dành cho founding members)
              </p>
              <div className="relative inline-block">
              ...
              <h1 className=" font-lamoric text-[8dvw] text-secondary font-normal leading-none ">
                1.299.000đ
              </h1>
            </div>
          </div>
        ...
        <MobileVoucherInView>
          <div className="relative w-[101%] translate-x-[2.5%]">
            ...
            <div className="absolute inset-0 font-gilroy text-secondary flex flex-col items-center pt-[8%] pl-[4.4%] pr-[21.5%] gap-[1.6dvw]">
              <h3 className="font-morgan font-normal text-[7dvw] text-primaryText leading-none">
                CORE VERSION
              </h3>
              <p className="font-gilroy font-normal text-[3.5dvw] text-secondary leading-none mt-[3dvw]">
                HỌC ĐỦ, DÙNG NGAY
              </p>
        ...
        <MobileVoucherInView>
          <div className="relative w-[101%] translate-x-[2.5%]">
            ...
            <div className="absolute inset-0 font-gilroy text-secondary flex flex-col items-center pt-[7%] pl-[4.4%] pr-[21.5%] gap-[1.6dvw]">
              ...
              <p className="font-gilroy font-normal text-[3vw] text-[#C18989] leading-none mt-[1dvw]">
                Cập nhật trọn đời
              </p>
