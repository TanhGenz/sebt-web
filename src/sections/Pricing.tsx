  ...
  return (
    <section className="w-full bg-beige relative translate-y-[-1px]">
      <div className="flex flex-col items-center pb-[4vw]">
        ...
        {/* board / 4  ele */}
        <div className="lg:w-[71.5dvw] w-full lg:pt-[2.2dvw] pt-[18px] lg:px-0 px-[18px]">
          {/* desktop */}
        ...
        {/* Desktop */}
        {/* big voucher ele */}
        <div className="lg:block hidden relative w-[76.5dvw] translate-x-[2.5%] mt-[5.2dvw]">
        ...
        {/* 2 ticket small */}
        <div className="w-full lg:flex hidden justify-center translate-x-[2%] gap-[7.4dvw] mt-[3dvw]">
